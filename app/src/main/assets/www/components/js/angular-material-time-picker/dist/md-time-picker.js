    ...
    .directive('mdTimePicker', function() {
      ...
      return {
        ...
        template: '<ng-form name="timeForm">' +
          '<button class="md-raised md-warn md-button md-ink-ripple" style="min-width:0%" type="button" ng-click="!readOnly && showPicker($event)" ng-disabled="readOnly">' +
          '<md-icon>' +
      ...
      this.$get = ["$mdDialog", function($mdDialog) {
        var timePicker = function(time, options) {
          ...
          return $mdDialog.show({
            controller: ['$scope', '$mdDialog', '$mdMedia','$rootScope', function ($scope, $mdDialog, $mdMedia,$rootScope) {
              var self = this;
		...
		$rootScope.$broadcast("medicationTime",this.time)
              };
            }],
